...
When base/lift control is toggled on, the current headset yaw is captured as neutral. Head yaw is then used as a position-following base yaw target; left-stick yaw still overrides head yaw.
