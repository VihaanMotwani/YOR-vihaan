...
public class ControllerState
{
    ...
    private bool leftXrDeviceLogged;
    private bool rightXrDeviceLogged;
    private bool leftXrDeviceMissingLogged;
    private bool rightXrDeviceMissingLogged;
    ...
    public void UpdateState()
    {
        ...
        UpdateControllerFromXr(
            ...
            "left",
            ref leftHandDevice,
            ref leftXrDeviceLogged,
            ref leftXrDeviceMissingLogged,
            ref leftX,
            ref leftY,
            ref leftMenu,
            ref leftThumbstick,
        ...
        UpdateControllerFromXr(
            ...
            "right",
            ref rightHandDevice,
            ref rightXrDeviceLogged,
            ref rightXrDeviceMissingLogged,
            ref rightA,
            ref rightB,
            ref rightMenu,
            ref rightThumbstick,
    ...
    private void UpdateControllerFromXr(
        ...
        ref bool deviceLogged,
        ref bool missingDeviceLogged,
        ...
        ref Quaternion localRotation)
    {
        ...
        if (!device.isValid)
        {
            ...
            InputDevices.GetDevicesWithCharacteristics(
                InputDeviceCharacteristics.HeldInHand | InputDeviceCharacteristics.Controller | handedness,
                controllerDevices);
        ...
        if (!device.isValid)
        {
            if (!missingDeviceLogged)
            {
                ...
                Logger.Log("Warning: no XR " + label + " controller device found");
            }
        ...
        {
            deviceLogged = true;
            Logger.Log("Using XR " + label + " controller device: " + device.name + " [" + device.characteristics + "]");
        }
